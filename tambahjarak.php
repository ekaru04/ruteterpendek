                  ...
                  <div class="chart tab-pane active" id=""
                      ...
                      <div class="form-group col-6 col-sm-6">
                        <label for="kec_awal">Kecamatan Awal</label>
                          <input type="hidden" name="kode_jarak" value="">
                          <input class="form-control" type="text" name="kec_awal" value=""  placeholder="Masukan Kecamatan Awal">

                        <label for="kec_tujuan">Kecamatan Tujuan</label>
                          <input class="form-control" type="text" name="kec_tujuan" value="" placeholder="Masukan Kecamatan Tujuan">
                      </div>
                      ...
                      <div>
                        <button type="submit" name="tambah" class="btn btn-primary" data-toggle="modal" data-target=".simpan-modal-sm"><i class="fa fa-save"></i>Tambah Jarak</button>
                      </div>
                      </div>
                    </form>
